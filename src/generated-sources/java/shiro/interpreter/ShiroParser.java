...
public class ShiroParser extends Parser {
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case NODE:
				enterOuterAlt(_localctx, 1);
				{
				setState(73); nodestmt();
				}
				break;
			case STATE:
				enterOuterAlt(_localctx, 2);
				{
				setState(74); statestmt();
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 3);
				{
				setState(75); graphDecl();
				}
				break;
			case NEWLINE:
	...
	public final StatestmtContext statestmt() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(79); match(STATE);
			setState(80); stateName();
			setState(81); match(BEGIN);
			setState(82); match(NEWLINE);
			setState(83); stateHeader();
	...
	public final StateHeaderContext stateHeader() throws RecognitionException {
		...
		try {
			...
			do {
				...
				case 1:
					{
					setState(86); stateGraphStmt();
					}
					break;
				case IDENT:
					{
					setState(87); activation();
					}
					break;
				case NEWLINE:
					{
	...
	public final NodestmtContext nodestmt() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(100); match(NODE);
			setState(101); match(IDENT);
			setState(106);
			_la = _input.LA(1);
			if (_la==LSQUARE) {
				{
				setState(102); match(LSQUARE);
				setState(103); activeSelector();
				setState(104); match(RSQUARE);
				}
			}

			setState(108); match(BEGIN);
			setState(109); match(NEWLINE);
			setState(110); nodeInternal();
	...
	public final NodeInternalContext nodeInternal() throws RecognitionException {
		...
		try {
			...
			do {
				...
				case 1:
					{
					setState(113); portstmt();
					}
					break;

				case 2:
					{
					setState(114); subjunctDeclNodeProd();
					}
					break;
				...
				case 3:
					...
					if (_la==OPTION) {
						{
						setState(115); match(OPTION);
						}
					}

					setState(118); nodestmt();
					}
					break;
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << 3) | (1L << 4) | (1L << 9) | (1L << OPTION) | (1L << NODE) | (1L << NEWLINE))) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final SubjunctDeclNodeProdContext subjunctDeclNodeProd() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(124); match(OPTION);
			setState(125); ((SubjunctDeclNodeProdContext)_localctx).type = match(IDENT);
			setState(126); match(PROD_OP);
			setState(127); ((SubjunctDeclNodeProdContext)_localctx).instanceName = match(IDENT);
	...
	public final NodeProductionContext nodeProduction() throws RecognitionException {
		...
		try {
			...
			do {
				{
				{
				setState(157); match(PROD_OP);
				setState(158); activation();
				}
				}
				setState(161); 
				_errHandler.sync(this);
	...
	public final ActivationContext activation() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(165); ((ActivationContext)_localctx).nodeName = match(IDENT);
			setState(169);
			_la = _input.LA(1);
			if (_la==LSQUARE) {
				{
				setState(166); match(LSQUARE);
				setState(167); ((ActivationContext)_localctx).activeObject = match(IDENT);
				setState(168); match(RSQUARE);
				}
			}
	...
	public final PortDeclContext portDecl() throws RecognitionException {
		...
		try {
			...
			if (_la==OPTION) {
				{
				setState(177); match(OPTION);
				}
			}

			setState(180); portType();
			setState(181); portName();
			setState(182); mfName();
			}
		}
		catch (RecognitionException re) {
	...
	public final PortDeclInitContext portDeclInit() throws RecognitionException {
		...
		try {
			...
			if (_la==OPTION) {
				{
				setState(184); match(OPTION);
				}
			}

			setState(187); portType();
			setState(188); portName();
			setState(189); mfCall();
			}
		}
		catch (RecognitionException re) {
	...
	public final PortstmtContext portstmt() throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(191); portDecl();
				}
				break;

			case 2:
				{
				setState(192); portDeclInit();
				}
				break;
			}
	...
	public final PathContext path() throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState