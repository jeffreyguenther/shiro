...
public class UnionMFuncTest {
    ...
    public void evaluate(){
        ...
        UnionMFunc mf = new UnionMFunc();
        List<Value> args = Arrays.asList(new Value(tableB, Table.class), new Value(tableC, Table.class));
        ...
        Assert.assertEquals(tableA, result);
    }
}
